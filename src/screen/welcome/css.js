...
const styles = StyleSheet.create({
   ...
   loginText:{ color: "#245FC7", fontSize: 16,fontFamily:Fonts.ProximaNovaSemibold},
   loginButton:{ borderColor: "#245FC7", height: 45, justifyContent: "center", alignItems: "center", width: "100%", borderRadius: 20, borderWidth: 1, },
   ...
   signupButton:{ backgroundColor: "#245FC7", height: 45, justifyContent: "center", alignItems: "center", width: "100%", borderRadius: 20,},
