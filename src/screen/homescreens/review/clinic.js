   ...
   const onPickersecond = () => {
    ...
    return (
        <ImageBackground source={Imagepath.background} style={{ flex: 1 }}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('bottomtab')} style={{ backgroundColor: "#245FC7", height: 50, justifyContent: "center", alignItems: "center", borderRadius: 10, width:"90%", alignSelf:"center", marginVertical: 10 }}>
