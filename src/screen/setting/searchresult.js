...
const styles = StyleSheet.create({
    ...
    textdata:{fontSize:20, color:"#000", ffontFamily:Fonts.ProximaNovaBold,textAlign:"center", marginVertical:15},
    button: { marginHorizontal: 20, backgroundColor: "#245FC7", height: 45, justifyContent: "center", alignItems: "center", borderRadius: 10, marginTop: 5 },
