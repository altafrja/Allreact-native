            ...
            < ScrollView
                ...
                <View style={styles.container1}>
                    ...
                    <TouchableOpacity style={styles.pageButton}>
                        <Image style={styles.pageButtonIcon} resizeMode='contain' source={Imagepath.Contact} />
                        <Text style={styles.pageButtonText}>contact us</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.pageButton}>
                        <Image style={styles.pageButtonIcon} resizeMode='contain' source={Imagepath.help} />
                        <Text style={styles.pageButtonText}>Help & support</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.pageButton}>
                        <Image style={styles.pageButtonIcon} resizeMode='contain' source={Imagepath.i} />
                        <Text style={styles.pageButtonText}>About us</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.pageButton}>
                        <Image style={styles.pageButtonIcon} resizeMode='contain' source={Imagepath.privacy} />
