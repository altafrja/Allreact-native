                    ...
                    <View style={styles.textInputMainView}>
                        ...
                        <View  style={styles.textInputPasswordView} >
                            ...
                            <TouchableOpacity onPress={() => securepassworddIcon()} >
                                <Image source={securepasswordIcon ? Imagepath.eyehide :Imagepath.eye} tintColor="#CCC"
...
const styles = StyleSheet.create({
    ...
    registerButtonText:{ color: "#245FC7", fontSize: 17, fontFamily:Fonts.ProximaNovaBold }
